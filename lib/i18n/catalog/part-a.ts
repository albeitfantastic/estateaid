...
export const catalogPartA: Record<string, unknown> = {
  ...
  estatesList: {
    ...
    emptySub: 'Add your first property, or ask an owner for an invite link.',
    emptyGuestTitle: 'No properties yet',
    emptyGuestSub: 'Ask the property owner for an invite link.',
  ...
  guestEstates: {
    title: 'Properties',
    emptyTitle: 'No properties yet',
    emptySub: 'Ask the property owner for an invite link.',
    enterCode: 'Enter a code',
  },
  guestRequests: {
    title: 'My Requests',
