    ...
    <ThemedView style={styles.container}>
      <View style={[styles.header, { paddingTop: insets.top + 12 }]}>
        ...
        <TouchableOpacity
          ...
          onPress={() => router.push(`/(owner)/estates/${estateId}/documents/upload` as never)}
        >
      ...
      {docs.length === 0 ? (
        <EmptyState icon="doc.fill" title="No documents yet" subtitle="Upload guides, manuals, and rules for your guests." actionLabel="Upload" onAction={() => router.push(`/(owner)/estates/${estateId}/documents/upload` as never)} />
      ) : (
            ...
            <View key={cat}>
              ...
              {catDocs.map((doc) => (
                <TouchableOpacity
                  ...
                  onPress={() => router.push(`/(owner)/estates/${estateId}/documents/${doc.id}` as never)}
                  activeOpacity={0.8}
                >
