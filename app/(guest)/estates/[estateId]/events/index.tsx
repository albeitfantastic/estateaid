    ...
    <ThemedView style={styles.container}>
      <View style={[styles.header, { paddingTop: insets.top + 12 }]}>
        ...
        <TouchableOpacity
          ...
          onPress={() => router.push(`/(guest)/estates/${estateId}/events/new` as never)}
          activeOpacity={0.8}
        >
      ...
      {estateEvents.length === 0 ? (
        <EmptyState
          ...
          onAction={() => router.push(`/(guest)/estates/${estateId}/events/new` as never)}
        />
      ) : (
            ...
            <>
              ...
              {recurring.map((ev) => (
                <TouchableOpacity
                  ...
                  onPress={() => router.push(`/(guest)/estates/${estateId}/events/${ev.id}` as never)}
                  activeOpacity={0.75}
                >
